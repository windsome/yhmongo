...
exports.SchemaMap = exports.Payment = exports.Roomrecord = exports.Room = exports.Order = exports.Product = exports.Shopextend = exports.Shop = exports.Userextend = exports.Userbase = exports.User = undefined;
...
var debug = (0, _debug3.default)('yh:mongo:schemas');
 ...
 * }
 */
var User = exports.User = new _mongoose.Schema({
  ...
  avatar: {
    type: String,
    default: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1595940140523&di=efe0b817a19768f8263e18aecd5fdfaf&imgtype=0&src=http%3A%2F%2Fn.sinaimg.cn%2Fsinacn%2Fw640h640%2F20180203%2F100c-fyrcsrx3577030.jpg'
  },
  address: _mongoose.Schema.Types.Mixed,
  wechat: { type: String, default: '' },
  mybalance: _mongoose.Schema.Types.Mixed,
 ...
 * }
 */
var Userbase = exports.Userbase = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  num: { type: Number, index: true, default: 0 },
  nickname: { type: String, default: '' },
  avatar: { type: String, default: '' },
  level: { type: Number, default: 0 },
  desc: { type: _mongoose.Schema.Types.Mixed, default: null },
  caps: { type: _mongoose.Schema.Types.Mixed, default: null }
}, {
  timestamps: true,
  versionKey: false
});
 ...
 * }
 */
var Userextend = exports.Userextend = new _mongoose.Schema({
  phone: { type: String, index: true, default: '' },
  password: { type: String, default: '' },
  vphone: { type: String, index: true, default: '' },
  address: _mongoose.Schema.Types.Mixed,
  wechat: _mongoose.Schema.Types.Mixed,
  wallet: _mongoose.Schema.Types.Mixed,
  stat: _mongoose.Schema.Types.Mixed,
  cert: _mongoose.Schema.Types.Mixed
}, {
  timestamps: true,
  versionKey: false
});
 ...
 * }
 */
var Shop = exports.Shop = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  num: { type: Number, index: true, default: 0 },
  ...
  cert: _mongoose.Schema.Types.Mixed,
  stat: _mongoose.Schema.Types.Mixed,
  owner: { type: _mongoose.Schema.Types.ObjectId, default: null }
}, {
  timestamps: true,
  versionKey: false
});
 ...
 * }
 */
var Shopextend = exports.Shopextend = new _mongoose.Schema({
  stat: _mongoose.Schema.Types.Mixed,
  payment: _mongoose.Schema.Types.Mixed
}, {
  timestamps: true,
  versionKey: false
});
 ...
 * }
 */
var Product = exports.Product = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  type: { type: Number, index: true, default: 0 },
  title: { type: String, default: '' },
  brief: { type: String, default: '' },
  summary: _mongoose.Schema.Types.Mixed,
  tags: _mongoose.Schema.Types.Mixed,
  category: _mongoose.Schema.Types.Mixed,
  priceOrg: { type: Number, default: 0 },
  price: { type: Number, default: 0 },
  start: Date,
  expire: Date,
  share: _mongoose.Schema.Types.Mixed,
  stock: { type: Number, default: 0 },
  desc: _mongoose.Schema.Types.Mixed,
  shop: { type: _mongoose.Schema.Types.ObjectId, default: null },
  owner: { type: _mongoose.Schema.Types.ObjectId, default: null }
}, {
  timestamps: true,
  versionKey: false
 ...
 * }
 */
var Order = exports.Order = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  buyer: { type: _mongoose.Schema.Types.ObjectId, default: null },
  seller: { type: _mongoose.Schema.Types.ObjectId, default: null },
  shop: { type: _mongoose.Schema.Types.ObjectId, default: null },
  payment: { type: _mongoose.Schema.Types.ObjectId, default: null },
  products: _mongoose.Schema.Types.Mixed,
  desc: _mongoose.Schema.Types.Mixed,
  fee: { type: Number, default: 0 },
  reward: _mongoose.Schema.Types.Mixed,
 ...
 * }
 */
var Room = exports.Room = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  name: { type: String, default: '' },
  brief: { type: String, default: '' },
  image: { type: String, default: '' },
  share: _mongoose.Schema.Types.Mixed,
  live: _mongoose.Schema.Types.Mixed,
  im: _mongoose.Schema.Types.Mixed,
  stat: _mongoose.Schema.Types.Mixed,
 ...
 * }
 */
var Roomrecord = exports.Roomrecord = new _mongoose.Schema({
  room: { type: _mongoose.Schema.Types.ObjectId, default: null },
  startAt: { type: Date, default: null },
 ...
 * }
 */
var Payment = exports.Payment = new _mongoose.Schema({
  status: { type: Number, index: true, default: 0 },
  fee: { type: Number, default: 0 },
  orders: _mongoose.Schema.Types.Mixed,
  type: { type: Number, default: 0 },
  extend: _mongoose.Schema.Types.Mixed,
  payer: { type: _mongoose.Schema.Types.ObjectId, default: null },
  payee: { type: _mongoose.Schema.Types.ObjectId, default: null },
  shop: { type: _mongoose.Schema.Types.ObjectId, default: null }
}, {
  timestamps: true,
  versionKey: false
...
User.plugin(_mongooseDelete2.default, { overrideMethods: true });
