    ...
    case '':
      {
        ...
        if ((0, _type2.default)(query) == 'array') {
          ...
          for (var _i2 = 0; _i2 < query.length; _i2++) {
            if (query[_i2] == _attrValue3) return true;
          }
          return false;
        } else if ((0, _type2.default)(_attrValue3) == 'array') {
          for (var _i3 = 0; _i3 < _attrValue3.length; _i3++) {
            if (query == _attrValue3[_i3]) return true;
          }
          return false;
        } else {
