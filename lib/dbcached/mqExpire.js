      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 56:
            ...
            debug('emitRedisUpdateEvent[5] create job ' + job.id, { type: 1, action: action });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 53:
            ...
            debug('dealRedisUpdate _dbRetrieveNoTotal', { section: section, s_start: s_start, s_stop: s_stop, s_count: s_count, s_try: s_try }, model, options, _result);
