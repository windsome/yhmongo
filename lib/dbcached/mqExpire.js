...
exports.dealSKey = exports.dealEvent = exports.timelyCheck = exports.emitRedisUpdateEvent = exports.REDIS_UPDATE_ACTION = undefined;
...
var emitRedisUpdateEvent = exports.emitRedisUpdateEvent = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(model, action, ids) {
    var timestamp, item, result, job;
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            timestamp = new Date().getTime();
            item = { model: model, action: action, ids: ids };
            _context2.next = 4;
            return (0, _redis.$r)().zaddAsync(REDIS_UPDATE_EVENT_KEY, timestamp, (0, _stringify2.default)(item));
          ...
          case 7:
            ...
            debug('emitRedisUpdateEvent create job ' + job.id, { type: 1, action: action });
...
var timelyCheck = exports.timelyCheck = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var count, _result, event, result, job;
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _redis.$r)().zcardAsync(REDIS_UPDATE_EVENT_KEY);
          ...
          case 3:
            ...
            _context3.next = 6;
            return (0, _redis.$r)().zrangeAsync(REDIS_UPDATE_EVENT_KEY, 0, 0, 'withscores');

          case 6:
            _result = _context3.sent;

            debug('timelyCheck', REDIS_UPDATE_EVENT_KEY, _result);
            ...
            _context3.next = 11;
            return (0, _redis.$r)().zremAsync(REDIS_UPDATE_EVENT_KEY, _result[0]);

          case 11:
            event = JSON.parse(_result[0]);
            _context3.next = 14;
            return dealEvent(event);
...
var dealEvent = exports.dealEvent = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(event) {
    var model, action, ids, typeofids, r_key_prefix, r_keys, result, reg_s_is_id, timestamp, i, r_key, keyFound, j, _$r;

    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            model = event.model, action = event.action, ids = event.ids;

            if (ids) {
              typeofids = (0, _type2.default)(ids);
          ...
          case 30:
            ...
            _context4.next = 33;
            return (_$r = (0, _redis.$r)()).zaddAsync.apply(_$r, [REDIS_UPDATE_SET_KEY].concat(result));
...
var dealSKey = exports.dealSKey = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(r_ckey) {
    var s_query, model, key_c, data_c, r_skey, result, arr, start, prev, i, curr, page_count, _i, section, s_start, s_stop, s_count, s_try, j, skip, limit, options, _result2, dbResult, dbFlatEntityMap, dbFlatResult, dbFlatSkip, collections, _i2, nModel, collection, ids, _j, id, item, key_d, _resultTmp, resultTmp, argsArray, _i3, _$r2;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 53:
            ...
            debug('dealRedisUpdate _dbRetrieveNoTotal', { section: section, s_start: s_start, s_stop: s_stop, s_count: s_count, s_try: s_try }, model, options, _result2);

            // 将entity数据插入redis.
            dbResult = _result2['result'];
          ...
          case 62:
            if (!(_i2 < collections.length)) {
              _context5.next = 81;
              break;
            }

            nModel = collections[_i2];
          ...
          case 73:
            _resultTmp = _context5.sent;

            debug('dealRedisUpdate setAsync', _resultTmp, key_d);
          ...
          case 83:
            resultTmp = _context5.sent;

            debug('dealRedisUpdate zremrangebyscore result:', r_skey, resultTmp);
            // 更新数据到有序集合.
            argsArray = [];

            for (_i3 = 0; _i3 < dbFlatResult.length; _i3++) {
              argsArray.push(dbFlatSkip + _i3);
              argsArray.push(dbFlatResult[_i3]);
            }
