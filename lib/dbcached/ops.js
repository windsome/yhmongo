      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            debug('_retrieve return from cache! ', (0, _stringify2.default)({ model: model, options: options, result: result && result.result }));
          ...
          case 53:
            debug('_retrieve return from db', (0, _stringify2.default)({ model: model, key_c: key_c, options: options, result: result && result.result }));
