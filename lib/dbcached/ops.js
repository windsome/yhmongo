      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            _context3.next = 14;
            return (0, _mqExpire.emitRedisUpdateEvent)(model, _mqExpire.REDIS_UPDATE_ACTION.CREATE_ONE, item._id);
...
var _deleteOne = exports._deleteOne = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(model, where, options) {
    var item, key_d, key_s, result1, result2;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 11:
            ...
            _context4.next = 15;
            return (0, _mqExpire.emitRedisUpdateEvent)(model, _mqExpire.REDIS_UPDATE_ACTION.REMOVE_ONE, item._id);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 10:
            ...
            _context5.next = 14;
            return (0, _mqExpire.emitRedisUpdateEvent)(model, _mqExpire.REDIS_UPDATE_ACTION.UPDATE_ONE, item._id);
    ...
    return _regenerator2.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 29:
            _context6.next = 31;
            return (0, _mqExpire.emitRedisUpdateEvent)(model, _mqExpire.REDIS_UPDATE_ACTION.CREATE_MANY, dbResult['result']);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 2:
            ...
            _context7.next = 5;
            return (0, _mqExpire.emitRedisUpdateEvent)(model, _mqExpire.REDIS_UPDATE_ACTION.UPDATE_MANY);
...
var _retrieveFromRedis = function () {
  var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(model, options) {
    var _ref14, where, sort, select, limit, skip, populates, key_c, key_s, data_c, score1, score2, count, data, items, entityMap, i, populate, nModel, typemodel, missing, _i2, key_d, item, _i3, nIds, _nModel, _populate, _typemodel, attrs, subitem, j, attr, _i4, _nId, key_d_populate, item_populate, result;
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            debug('_retrieveFromRedis ', { model: model, options: options }, { skip: skip, limit: limit, key_c: key_c, key_s: key_s });
            ...
            if (populates) {
              for (i = 0; i < populates.length; i++) {
                ...
                if (typemodel === 'string') nModel = populate.model;else if (typemodel === 'array') nModel = populate.model[0];else {
                  debug('warning! not support populate!', { populate: populate, typemodel: typemodel });
                }
                entityMap[nModel] = {};
              }
            }
          ...
          case 36:
            ...
            return _context12.abrupt('continue', 80);
