...
Promise.resolve(1)
  .then(ret => {
    return ops._retrieve('mark', { limit: 10 }).then(result => {
      console.log('_retrieve result:', result);
    });
  })
  .then(ret => {
  ...
  .then(ret => {
    ...
    return ops._retrieve('mark', { where: { table: 'postTest3' }, limit: 10 });
  })
  .then(ret => {
